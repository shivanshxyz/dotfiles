...
function printOperationsArray(operations) {
  ...
  while (i < operations.length) {
    ...
    switch (operation) {
      ...
      case constants["n" /* TREE_OPERATION_REMOVE_ROOT */]:
        {
          i += 1;
      ...
      case constants["o" /* TREE_OPERATION_REORDER_CHILDREN */]:
        {
          const id = operations[i + 1];
      ...
      case constants["q" /* TREE_OPERATION_UPDATE_TREE_BASE_DURATION */]:
      ...
      case constants["p" /* TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS */]:
        const id = operations[i + 1];
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return TREE_OPERATION_UPDATE_TREE_BASE_DURATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return UNSUPPORTED_VERSION_URL; });
...
try {
  // $FlowFixMe
  const rawStyleString = __webpack_require__(52).default;
...
var react_debug_tools = __webpack_require__(54);
...
var DevToolsFeatureFlags_extension_oss = __webpack_require__(28);
...
function attach(hook, rendererID, renderer, global) {
  ...
  function recordPendingErrorsAndWarnings() {
    ...
    fibersWithChangedErrorOrWarningCounts.forEach(fiberID => {
      ...
      if (fiber != null) {
        ...
        pushOperation(constants["p" /* TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS */]);
  ...
  function recordProfilingDurations(fiber) {
    ...
    if (isProfiling) {
      ...
      if (alternate == null || treeBaseDuration !== alternate.treeBaseDuration) {
        ...
        pushOperation(constants["q" /* TREE_OPERATION_UPDATE_TREE_BASE_DURATION */]);
        pushOperation(id);
  ...
  if (Object(storage["d" /* sessionStorageGetItem */])(constants["k" /* SESSION_STORAGE_RELOAD_AND_PROFILE_KEY */]) === 'true') {
    startProfiling(Object(storage["d" /* sessionStorageGetItem */])(constants["j" /* SESSION_STORAGE_RECORD_CHANGE_DESCRIPTIONS_KEY */]) === 'true');
...
exports.version = "17.0.3-experimental-b0407b55f";
